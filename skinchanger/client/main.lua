...
RegisterNetEvent('radial-skin')
AddEventHandler('radial-skin', function(cb)
	cb(Character)
end)

RegisterNetEvent('skinchanger:setLastSkinNewAcc')
AddEventHandler('skinchanger:setLastSkinNewAcc', function(NewAcc)
	Character = NewAcc
end)
